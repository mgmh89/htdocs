        ...
        <script type="text/javascript" >
            $(function() {
                $(".submit").click(function()
                {
                    ...
                    var comment = $("#com_dis").val();
                    var post_id = $("#com_id").val();
                    var dataString = 'com_name=' + name + '&com_email=' + email + '&com_dis=' + comment + '&post_id=' + post_id;
    ...
    <body>
        ...
        <div >
            <form action="commentajax.php" method="post">
                <input type="hidden" name="com_id" id="name" value="<?php echo $post_id; ?>"/> 
                <input type="text" name="com_name" id="name"/>Name<br />
                <input type="text" name="com_email" id="email"/>Email<br />
                <textarea id="comment" name="com_dis"></textarea><br />
